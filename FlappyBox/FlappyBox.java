...
public class FlappyBox extends FallingBox {
   ...
   */
  public void jump() {
    //increase height by the velocity every jump
    setY(getY() + jumpVelocity);
    setFallingSpeed(GameConstant.FALLING_SPEED); //reset falling speed
    //apply gravity after the jump
    setFallingAcceleration(GameConstant.GRAVITY);
